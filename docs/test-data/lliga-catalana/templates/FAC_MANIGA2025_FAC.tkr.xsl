...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="NYP_pilots">
    ...
    <xsl:if test="$has_nyp != ''">
      <div class="fs_res" style="page-break-before: always;">
        <h3>Pilots sense processar (NYP)</h3>
        <table class="fs_res">
          <thead>
            <tr>
    ...
    <table class="fs_res">
      <thead>
        <tr>
          ...
          <th class="fs_res">Id</th>
          <th class="fs_res">Radi</th>
          <!--th>Type</th-->
          <th class="fs_res">Obre</th>
          <th class="fs_res">Tanca</th>
          <th class="fs_res">Coordenades</th>
          <th class="fs_res">Altitud</th>
        </tr>
      </thead>
      <tbody>
  ...
  <xsl:template name="result_heading_row">
    <tr>
      ...
      <xsl:if test="$es != ''">
        <th class="fs_res">SSS</th>
        <th class="fs_res">ESS</th>
        <th class="fs_res">
          Temps<br/>[h:m:s]
        </th>
        <th class="fs_res">
      ...
      <body>
        <div>
          <div class="fs_res">
			...
			<!--[MVM] PARA QUE NO LISTE LOS ABSENTS -->
			  <xsl:if test="boolean(@no_distance ='ABS')= false()">
