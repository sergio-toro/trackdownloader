...
<!-- Template for task team results -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  -->
  <xsl:variable name="filter" select="/Fs/FsCompetition/FsTasks/FsTask[@id=$task_id]/FsTeamResults/FsTeamResult[@id=$result_id]"/>
  ...
  <xsl:variable name="task_score_parameter" select="$task/FsTaskScoreParams"/>
