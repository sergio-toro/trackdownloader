...
const LeagueTable: React.FC<Props> = ({
  ...
  return (
    <div className="mb-10 bg-zinc-100 rounded-md relative border-2 border-gray-200 shadow-md p-4">
      <div className="flex gap-4 mb-4 items-center absolute right-6 top-2 ">
      ...
      <DropDownButton text={`LEAGUE ${league}`}>
        <table ref={tableRef}>
          <thead>
            <tr>
              <th>ID</th>
