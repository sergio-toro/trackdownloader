...
import TaskMap3D from "./TaskMap3D";

interface TrackPreview3DModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const TrackPreview3DModal: React.FC<TrackPreview3DModalProps> = ({
  isOpen,
  onClose,
  participant,
  task,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] mx-4 flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">
              {participant.name}
              <span className="ml-2 text-sm font-normal text-gray-500">3D</span>
            </h3>
...
export default TrackPreview3DModal;
